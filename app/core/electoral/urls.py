...
urlpatterns = [
    ...
    path(
        "distrito/update/<int:pk>/",
        DistritoUpdateView.as_view(),
        name="distrito_update",
    ),
    path(
        "distrito/delete/<int:pk>/",
        DistritoDeleteView.as_view(),
        name="distrito_delete",
    ),
    # Seccional
    ...
    path(
        "seccional/update/<int:pk>/",
        SeccionalUpdateView.as_view(),
        name="seccional_update",
    ),
    path(
        "seccional/delete/<int:pk>/",
        SeccionalDeleteView.as_view(),
        name="seccional_delete",
    ),
    # Paises
    ...
    path(
        "manzana/update/<int:pk>/", ManzanaUpdateView.as_view(), name="manzana_update"
    ),
    path(
        "manzana/delete/<int:pk>/", ManzanaDeleteView.as_view(), name="manzana_delete"
    ),
    # Tipo Voto
    ...
    path(
        "tipovoto/update/<int:pk>/",
        TipoVotoUpdateView.as_view(),
        name="tipo_voto_update",
    ),
    path(
        "tipovoto/delete/<int:pk>/",
        TipoVotoDeleteView.as_view(),
        name="tipo_voto_delete",
    ),
    # Operador
    ...
    path(
        "operador/update/<int:pk>/",
        OperadorUpdateView.as_view(),
        name="operador_update",
    ),
    path(
        "operador/delete/<int:pk>/",
        OperadorDeleteView.as_view(),
        name="operador_delete",
    ),
    # Local Votacion
    path("localvotacion", LocalVotacionListView.as_view(), name="local_votacion_list"),
    path(
        "localvotacion/add/",
        LocalVotacionCreateView.as_view(),
        name="local_votacion_create",
    ),
    path(
        "localvotacion/update/<int:pk>/",
        LocalVotacionUpdateView.as_view(),
        name="local_votacion_update",
    ),
    path(
        "localvotacion/delete/<int:pk>/",
        LocalVotacionDeleteView.as_view(),
        name="local_votacion_delete",
    ),
    # Elector
    path("elector", ElectorListView.as_view(), name="elector_list"),
    path("elector/add/", ElectorCreateView.as_view(), name="elector_create"),
    path(
        "elector/update/<int:pk>/", ElectorUpdateView.as_view(), name="elector_update"
    ),
    path(
        "elector/delete/<int:pk>/", ElectorDeleteView.as_view(), name="elector_delete"
    ),
    # Carga de Votos
    path(
        "carga_dia_d_list_mv", CargaDiaDListView.as_view(), name="carga_dia_d_list_mv"
    ),
    path(
        "carga_dia_d_list_pc",
        CargaDiaDElectorView.as_view(),
        name="carga_dia_d_list_pc",
    ),
    path(
        "carga_dia_d_list_gs",
        CargaDiaDElectorViewGs.as_view(),
        name="carga_dia_d_list_gs",
    ),
    path("carga_dia_d/add/", CargaDiaDCreateView.as_view(), name="carga_dia_d_create"),
    path(
        "carga_dia_d/update/<int:pk>/<opcion>/<valor>/<monto>/",
        CargaDiaDUpdateView.as_view(),
        name="carga_dia_d_update",
    ),
    path(
        "carga_dia_d/delete/<int:pk>/",
        CargaDiaDDeleteView.as_view(),
        name="carga_dia_d_delete",
    ),
    path(
        "registro-voto-rapido/",
        RegistroVotoRapidoView.as_view(),
        name="registro_voto_rapido",
    ),
    path(
        "registro-voto-rapido-movil/",
        RegistroVotoMovilView.as_view(),
        name="registro_voto_rapido_movil",
    ),
    path(
        "quick-update-voto/",
        quick_update_voto_endpoint,
        name="quick_update_voto",
    ),
