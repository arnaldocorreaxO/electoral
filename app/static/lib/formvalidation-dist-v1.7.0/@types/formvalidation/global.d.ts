...
declare namespace FormValidation {
    ...
    namespace core {
        ...
        class Core {
            ...
            on(event: string, func: (...arg: any[]) => any): Core;
            off(event: string, func: (...arg: any[]) => any): Core;
            emit(event: string, ...args: any[]): Core;
            
            registerPlugin(name: string, plugin: Plugin<any>): Core;
            deregisterPlugin(name: string): Core;
            
            registerValidator(name: string, func: () => ValidateFunction): Core;
            registerFilter(name: string, func: (...arg: any[]) => any): Core;
            deregisterFilter(name: string, func: (...arg: any[]) => any): Core;
            executeFilter<T>(name: string, defaultValue: T, args: any[]): T;
            ...
            updateValidatorOption(field: string, validator: string, name: string, value: any): Core;
    ...
    // -----
    namespace utils {
        function call(functionName: ((...arg: any[]) => any) | string, args: any[]): any;
